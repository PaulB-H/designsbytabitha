...
if($_SESSION["user"]===null){
    ...
    //BELOW CODE OBSOLETE DUE TO: 
    //$lastid = $stmt->insert_id;
    //AFTER stmt->execute()
    // $return_arr = array();
    // $query = "SELECT MAX(OrderNum) AS maxOrderNumber FROM orders";
    // $result = mysqli_query($con,$query);
    // $row = mysqli_fetch_array($result);
    // $maxOrderNumber = $row["maxOrderNumber"];
    // $thisOrderNumber = $maxOrderNumber;
    // $thisOrderNumber ++;
    // echo JSON_encode($thisOrderNumber);
